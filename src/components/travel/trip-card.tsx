...
export function TripCard({ post, isOwnPost }: TripCardProps) {
    ...
    return (
        <Dialog>
            ...
            {/* FULL DETAILS DIALOG */}
            <DialogContent className="sm:max-w-lg bg-zinc-950 border-zinc-800 text-zinc-200 max-h-[80vh] flex flex-col">
                {/* Fixed Header */}
                ...
                <div className="flex-1 overflow-y-auto space-y-6 pt-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                    {/* Large Route */}
